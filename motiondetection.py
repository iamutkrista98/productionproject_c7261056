...
def motiondetect():
    ...
    while True:
        ...
        if len(contr) > 0:
            ...
            cv2.putText(frame1,"MOTION DETECTED",(10,80),cv2.FONT_HERSHEY_COMPLEX,2,(0,255,0),2)

        else:
            cv2.putText(frame1,"NO MOTION DETECTED",(10,80),cv2.FONT_HERSHEY_COMPLEX,2,(0,0,255),2)
