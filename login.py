...
def login():
    ...
    if username=='admin' and password=='1234':
        ...
        messagebox.showerror("Authentication Error!","Invalid Username or Password Supplied!")
...
label=Label(frame,text='Dont Have Credentials? ',fg='black',bg='white',font=('Microsoft YaHei UI Light',9))
